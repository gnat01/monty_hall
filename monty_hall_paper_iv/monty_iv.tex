...
threshold, and supplement the theorem with empirical Stage 1 evidence: theory
versus simulation curves and collapse plots across distinct unequal prize
vectors with the same total reward mass.
\end{abstract}
