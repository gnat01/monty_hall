...
at random among door labels.  In that case, unequal rewards still collapse to
a single scalar, the total reward mass
\[
  V=\sum_{i=1}^m v_i.
\]
...
threshold, and identify the labeled unequal-prize problem as the genuinely new
Part IV direction.
\end{abstract}
...
altered by the reveals.  After $t$ reveals, the remaining non-initial closed
set has size $K-1-t$, and symmetry implies that uniform switching spreads this
...
with only a rescaling of value.
